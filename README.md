...
• Automation and event-driven programming with Lambda & Python
...
Project Aegis is more than a secure file system. I built it to handle real-world challenges like DynamoDB throttling, duplicate alerts, object lock misconfigurations, and large file timeouts. This ensures files are always authentic, traceable, and tamper-proof, demonstrating my ability to solve complex cloud problems with automation, reliability, and security.
